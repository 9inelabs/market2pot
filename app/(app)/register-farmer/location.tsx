...
// Reuses the exact same location-detection hook and copy as the original
// signup flow's farm-location.tsx — this screen's only real difference is
// what happens on Continue (advance this wizard, not profiles.step).
export default function RegisterFarmerLocationScreen() {
  const {
    addressLine,
    detected,
    detecting,
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      router.push('/(app)/register-farmer/bank-details');
    } catch (err) {
