// Deno-side copy of src/lib/nameMatch.ts. Duplicated rather than imported
// across the app/functions boundary (Edge Function deploys upload based on
// this directory tree; reaching outside supabase/functions/ for a relative
// import is fragile). The app's copy is only ever used for live UI feedback
// while typing; THIS copy is the authoritative check for what actually gets
// persisted (see submit-bank-account). Keep both in sync if the matching
// algorithm changes.
